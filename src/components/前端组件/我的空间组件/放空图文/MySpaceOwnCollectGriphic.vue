...
export default {
  ...
  mounted() {
    ...
    this.getUserSpaceGriphicUserCollectionOrderByCreateTime()
  },
  methods: {
    getUserSpaceGriphicUserCollectionOrderByCreateTime() {
      axios.get('/getUserSpaceGriphicUserCollectionOrderByCreateTime').then(response => {
